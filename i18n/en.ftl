...
start =
    ...
    .text = 
            ...
            <blockquote>To receive a gift, you need to hit the center of all targets 🎁</blockquote>
            <blockquote>An NFT gift can only be won in games marked with the 💎 symbol</blockquote>
referral =
    .text = 
